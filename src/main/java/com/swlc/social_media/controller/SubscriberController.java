...
public class SubscriberController {
        ...
        subscribeButton.setOnAction(event -> {
            if (subBtnAction.equals("sub")) {
                channelModel.subscribeChannel(
                        UserLoginController.getLoggedChannel(),
    ...
    public void onClickSubscribedBtn(ActionEvent actionEvent) {
        ...
        ChannelDTO channelDTOArray = channelModel.getSubscribedChannelsByChannelId(UserLoginController.loggedChannel.getChannelId());
    ...
    public void displayUnSubChannels() {
        ...
        for (ChannelDTO channel : allChannels) {
            if (channel.getChannelId() != UserLoginController.getLoggedChannel().getChannelId() && !subscribedChannelIds.contains(channel.getChannelId())) {
                addPost(channel.getChannelName(), channel.getLogo(), channel.getChannelId());
            }
        }
    }
